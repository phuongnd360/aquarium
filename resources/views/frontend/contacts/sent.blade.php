        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12">
                <div class="contact-info-left">
                    ...
                    <ul class="contact-us">
                        <li>
                            <p><i class="fas fa-map-marker-alt"></i>{{trans('page.lbl_address')}} 1: <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d245.0047226750079!2d106.63407188115316!3d10.728655340161232!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752e74955d886f%3A0x292ed1df2158ef2c!2zMTIxLCA0IEjhurttIFPhu5EgNSBN4buFIEPhu5FjLCBwaMaw4budbmcgMTUsIFF14bqtbiA4LCBI4buTIENow60gTWluaCwgVmlldG5hbQ!5e0!3m2!1sen!2sus!4v1577349657508!5m2!1sen!2sus" target="_blank">{{trans('page.txt_address1')}}</a> </p>
                            <p><i class="fas fa-map-marker-alt"></i>{{trans('page.lbl_address1')}} 2: <a href="https://maps.google.com/?ll=38.882147,-76.99017" target="_blank">{{trans('page.txt_address2')}}</a> </p>
                        </li>
                        <li>
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="contact-form-right">
                    ...
                    <div class="text-center msg-sent">
                        <p class="text-center">
                            <h2 class="grey">{{trans('page.msg_contact_sent1')}}</h2>
                            <span class="black"> {{trans('page.msg_contact_sent2')}} </span>
                        </p>
                    </div>  
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="submit-button text-center">
                                    <button class="btn btn-default-hover" type="button" onClick="location.href='{{route('frontend.home.index')}}'">← {{trans('page.btn_home_back')}}</button>
