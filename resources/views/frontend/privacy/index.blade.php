...
<div class="container">
                ...
                <!-- Terms List -->
                <dl class="terms-list">
                    <dt class="heading-6 text-grayscale-darker text-regular">General information</dt>
                    ...
                    <dt class="heading-6 text-grayscale-darker text-regular">Right to access, correct and delete data and to object to data
                                                        processing
                    </dt>
                    ...
                    <dt class="heading-6 text-grayscale-darker text-regular">Management of personal data</dt>
                    ...
                    <dt class="heading-6 text-grayscale-darker text-regular">Information We Collect</dt>
                    ...
                    <dt class="heading-6 text-grayscale-darker text-regular">How We Use Your Information</dt>
                    ...
                    <dt class="heading-6 text-grayscale-darker text-regular">Sharing Your Information</dt>
                ...
                <!-- END Terms List -->
                <a href="mailto:#" class="text-primary" style="text-decoration: underline; display: inline-block; margin-top: 32px;">privacy@demolink.org</a>
                <hr>
            </div>
@endsection