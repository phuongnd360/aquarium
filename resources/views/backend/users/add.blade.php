          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title"><strong>User Add</strong></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="frm-user-add" class="form-horizontal" role="form" method="post" action="{{route('backend.users.add')}}" accept-charset="utf-8" enctype="multipart/form-data">
              	@csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="password" class="col-sm-2 col-form-label">Password <span class="red">※</span></label>
                    <div class="col-sm-10">
                      <input type="password" class="form-control" name="password" id="password" placeholder="Password" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="password_conf" class="col-sm-2 col-form-label">Password Confirm <span class="red">※</span></label>
                    <div class="col-sm-10">
                      <input type="password" class="form-control" name="password_conf" id="password_conf" placeholder="Password Confirm" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select name="status" class="form-control" style="width: 30%;">
							<option value="1" class="green">Active</option>
							<option value="2" class="red">Inactive</option>
						</select>
                    </div>
                  </div>
                </div>
            ...
            $("#frm-user-add").validate({
                rules: {
                    ...
                    username: {
                        required: true,
                        remote: {
		                    url:"{{route('backend.users.chkusers')}}",
		                    type:"get"
		               }
                    },
                    email: {
