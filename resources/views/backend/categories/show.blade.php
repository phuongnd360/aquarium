            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title"><strong>Category Detail</strong></h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="frm-cat-edit" class="form-horizontal" role="form" method="post" action="{{route('backend.categories.show',$category->id)}}" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <div class="offset-sm-2">
                                ...
                                <button type="button" class="btn btn-info" onclick="location.href='{{route('backend.categories.edit',$category->id)}}'"><i class="far fa-edit"></i> Edit</button>
                  				<button type="button" class="btn btn-danger" onclick="location.href='{{route('backend.categories.delete',$category->id)}}'"><i class="far fa-trash-alt"></i> Delete</button>
                            </div>
                        </div>
                        <!-- /.card-footer -->
                    </form>
