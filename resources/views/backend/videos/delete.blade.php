        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="frm-video-delete" class="form-horizontal" role="form" method="post" action="{{route('backend.videos.delete',$video->id)}}" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <div class="offset-sm-2">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='{{route('backend.videos.index')}}'"><i class="fa fa-reply-all"></i> Back Category List</button>
                            </div>
                        </div>
                        <!-- /.card-footer -->
                    </form>
