            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title"><strong>Video Create</strong></h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="frm-video-create" class="form-horizontal" role="form" method="post" action="{{route('backend.videos.create')}}" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                        <div class="radio radio-info">
                                          <label>
                                            <input type="radio" name="type_video" class="type" id="type_embed" value="1">
                                            Embed Video (Youtube)
                                          </label>
                                        </div>
                                        <div class="radio radio-info">
                                          <label>
                                            <input type="radio" name="type_video" class="type" id="type_file" value="2">
                                ...
                                <div class="control-group"> 
                                    ...
                                    <textarea class="form-control input-width" id="embed_video" name="embed_video" placeholder="Embed Video"></textarea>                
                                </div>
                            </fieldset>
                                <fieldset class="scheduler-border">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title_en" id="title_en" placeholder="Video Title (English)">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="title_vi" class="col-sm-2 col-form-label">Title(Vi) <span class="red">※</span></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title_vi" id="title_vi" placeholder="Video Title (Vietnam)">
                                </div>
                            </div>
...
<script>
    ...
    if ($("#frm-video-create").length > 0) {
        $("#frm-video-create").validate({
            rules: {
                video_file: {                    
