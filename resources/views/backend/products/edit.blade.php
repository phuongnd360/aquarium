            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title"><strong>Product Edit</strong></h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form name="frm-pro-edit" id="frm-pro-edit" class="form-horizontal" role="form" method="post" action="{{route('backend.products.edit', $product->id)}}" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control width-sort txt-center" id="sort" name="sort" value="{{$product->sort}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10" >
                                    ...
                                    <div id="img-preview" class="img-box">
                                    	...
                                    	<img src="{{asset('storage/uploads/products/thumbs')}}/{{$product->image_primary}}" class="img-circle img-product"></a>
                                    	@else
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="img-more-input img-more-box" id="img-preview-more">
                                    	@if(!empty($product->image_more))
                                            ...
                                            <a href="{{asset('storage/uploads/products/thumbs')}}/{{$imgMore}}" target="_blank">
                                    		<img src="{{asset('storage/uploads/products/thumbs')}}/{{$imgMore}}" class="img-circle img-product"></a>
                                    		@endforeach
                                    	@endif
                                    	
                                    </div>
                                    <div class="img-more-input div-image">
                                    	<div class="inline-block">
...
<script>
    ...
    if ($("#frm-pro-edit").length > 0) {
        $("#frm-pro-edit").validate({
            rules: {
                cat_id: {
                    required: true
                },
                ...
                image_primary: {
                    required: function(element){
                        if($('#radio_img_primary2').is(':checked')){
                          return true;
                        } else {
                          return false;
                        }
