            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title"><strong>Product Detail</strong></h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="frm-pro-show" class="form-horizontal" role="form" method="post" action="{{route('backend.products.show',$product->id)}}" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a href="{{asset('storage/uploads/products/thumbs')}}/{{$imm}}" title="View Image" target="_blank">
                        ...
                        <div class="card-footer">
                            <div class="offset-sm-2">
                                ...
                                <button type="button" class="btn btn-info" onclick="location.href='{{route('backend.products.edit',$product->id)}}'"><i class="far fa-edit"></i> Edit</button>
                  				<button type="button" class="btn btn-danger" onclick="location.href='{{route('backend.products.delete',$product->id)}}'"><i class="far fa-trash-alt"></i> Delete</button>
                            </div>
                        </div>
                        <!-- /.card-footer -->
                    </form>
